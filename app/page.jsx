    ...
    <div className="pt-20 flex flex-col">
      <section className="relative py-16 md:py-28">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 bg-gradient-to-br from-blue-500 to-green-500 gradient font-extrabold tracking-tighter pr-2 pb-2 text-transparent bg-clip-text">
              Discover your next ride with Avexa
            </h1>
            <p className="text-xl text-gray-500 mb-8 max-2xl mx-auto">
              Find your perfect vehicle with intelligent recommendation.
            </p>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-16 bg-black/50 text-white">
