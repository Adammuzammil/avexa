...
const CarDetails = ({ car, testDriveInfo }) => {
  ...
  return (
    <div>
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-5/12">
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Avexa EMI Calculator</DialogTitle>
                <EMICalculator amount={car.price} />
              </DialogHeader>
            </DialogContent>
          </Dialog>
      ...
      <div className="mt-8 p-6 bg-white rounded-lg shadow-sm">
        <h2 className="text-2xl font-bold mb-6">Dealership Info</h2>
